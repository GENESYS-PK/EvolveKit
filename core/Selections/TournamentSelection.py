...
class TournamentSelection(Selection):
    ...
    allowed_representation = ['real', 'binary']  # Przykładowo może działać z różnymi reprezentacjami

    def __init__(self, target_population: int, maximize: bool, tournament_size: int = 3):
    ...
    def _select(self, population: Population) -> Population:
        ...
        while len(selected_individuals) < self.target_population:
            ...
            tournament = [population.population[index_1], population.population[index_2]]
